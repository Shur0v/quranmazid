...
import { BookOpen, Bookmark, ChevronDown, ChevronRight, ChevronUp, Ellipsis, Play } from "lucide-react";
          ...
          <div className="grid grid-cols-[299px_1fr_333px] pt-[60px]">
            ...
            <aside className="border-l border-[#1b2432] bg-[#0d0d0d] px-5 py-6">
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between text-[#c4c4c4] py-3">
