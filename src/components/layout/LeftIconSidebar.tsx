...
export default function LeftIconSidebar() {
  return (
    <aside className="h-dvh border-r border-[#24262b] bg-[#171717]">
      <nav className="fixed bottom-0 isolate z-[3] h-dvh w-[60px] translate-y-0 bg-[#171717]">
        <div className="flex h-full w-full flex-col items-center">
          <a className="py-3" href="/">
            <Image src="/logo.svg" alt="Quran Mazid Logo" width={36} height={36} className="h-9 w-9" priority />
          </a>

          <div className="flex h-[calc(100dvh-120px)] flex-col items-center justify-center gap-6 text-[#8f9491]">
