...
export default function LeftbarOthersIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" {...props}>
            ...
            <path d="M13.75 14.2083H19.25" stroke="currentColor" strokeWidth="2.0" strokeLinecap="round" />
            <path d="M13.75 17.875H19.25" stroke="currentColor" strokeWidth="2.0" strokeLinecap="round" />
        </svg>
    );
}
